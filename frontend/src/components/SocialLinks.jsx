    ...
    <>
      ...
      <div className="relative">
        ...
        <div className="relative flex items-end gap-x-2 p-2">
          <div className="relative">
            <a href="https://github.com/surjanthakur/cifrar-chat">
              <div
          ...
          <div className="relative">
            <a href="https://www.youtube.com/@imsurjan_thakur">
              <div
                style={{ clipPath: "url(#squircleClip)" }}
          ...
          <div className="relative">
            <a href="https://www.youtube.com/@imsurjan_thakur">
              <div
                style={{ clipPath: "url(#squircleClip)" }}
                className="w-14 h-14 bg-linear-to-br from-red-600 to-red-800 rounded-xl flex items-center justify-center shadow-lg border border-red-500/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2 hover:shadow-2xl"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
